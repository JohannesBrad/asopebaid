    ...
    <>
      <div className="fixed top-0 bg-white w-full border-b border-gray-200 px-6 flex justify-between items-center p-4 z-10">
        ...
        >
            ...
            <div className="flex items-center py-2 px-6 rounded-md w-[20rem] justify-start">
            ...
            <button
              className="w-40 bg-red-500 text-white py-2 rounded-md flex items-center justify-center gap-2 hover:bg-red-600 cursor-pointer"
